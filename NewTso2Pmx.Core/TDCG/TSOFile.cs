...
namespace TDCG
{
    ...
    public class TSOSubScript
    {
        ...
        {
            this.lines = LegacyEncoding.ReadAllLinesWithDetection(source_file);
        }
        ...
        {
            LegacyEncoding.WriteAllLinesShiftJis(dest_file, this.lines);
        }
    ...
    public class TSOFile : IDisposable
    {
        ...
        {
            BinaryReader reader = LegacyEncoding.CreateShiftJisBinaryReader(source_stream);
